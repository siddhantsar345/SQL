...
INNER JOIN
    bigfoot_external_neo.cp_uie__account_demographics_insight_beta_fact demographics
    ON sales.account_id = demographics.account_id
LEFT JOIN
