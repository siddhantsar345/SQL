  SELECT
    ...
    EXTRACT(HOUR FROM from_unixtime(unix_timestamp(sales.unit_creation_date_time, 'MM/dd/yy HH:mm'))) AS hour_of_day,
  ...
  GROUP BY
    ...
    EXTRACT(HOUR FROM from_unixtime(unix_timestamp(sales.unit_creation_date_time, 'MM/dd/yy HH:mm'))),
