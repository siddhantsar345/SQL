...
AND lower(sales.analytic_super_category) in ('toysandss','healthcare','booksmedia','sportfitness','babycare','autoaccessorys','householdsupplies','pets','industrial&scientific','digitalsubscription')
