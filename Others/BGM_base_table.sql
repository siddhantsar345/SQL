create table adhoc_ttl_90days.healthcare_on_base_16th_Sept_2025 as 
SELECT
...
fdp_uploads.ds_fkint_cp_santa_hyperlocal_vertical_bu_mapping_2_0 AS hl 
  ...
  AND lower(sales.analytic_super_category) IN ('healthcare')) as a 
  ...
  AND sales.order_date_key between 20240914 and 20250915
  AND sales.is_shopsy_order = FALSE
  AND lower(sales.analytic_vertical) IN ('resistancetube', 'fitnessgrip', 'abexerciser', 'dumbbell')
