SELECT
    sub2.marketplace_id,
    sub2.analytic_business_unit,
    sub2.order_date_key,
    sub2.analytic_super_category,
    sub2.analytic_category,
    sub2.analytic_sub_category,
    sub2.product_id,
    sub2.analytic_vertical,
    sub2.brand,
    sub2.Alpha_Flag,
    sub2.FBF_Flag,
    sub2.listing_price,
    ...
    sub2.COD_Fee,
    sub2.mrp,
    sub2.listing_price_coins,
    sub2.listing_price_coins_base_currency,
    sub2.construct_fee_value,
    ...
    -- COGSXFSN column
    sub2.cogsxfsn__cost_per_unit,

    -- IMXFSN columns
    sub2.imxfsn_type,
    sub2.imxfsn__im_in_percentage,

    -- IMXSC column
    sub2.imxsc__im_in_percentage,

    -- RTO_RVP_FSN columns
    sub2.rto_rvp_fsn__rto_percentage_gmv,
    sub2.rto_rvp_fsn__rto_percentage_units,
    sub2.rto_rvp_fsn__rvp_percentage_value,
    sub2.rto_rvp_fsn__rvp_percentage_units,

    -- RTO_RVP_SCXVerticalBrand columns
    sub2.rto_rvp_scxverticalbrand__rto_percentage_gmv,
    sub2.rto_rvp_scxverticalbrand__rto_percentage_units,
    sub2.rto_rvp_scxverticalbrand__rvp_percentage_value,
    sub2.rto_rvp_scxverticalbrand__rvp_percentage_units,

    -- RTO_RVP_SCXVertical columns
    sub2.rto_rvp_scxvertical__rto_percentage_value,
    sub2.rto_rvp_scxvertical__rto_percentage_units,
    sub2.rto_rvp_scxvertical__rvp_percentage_value,
    sub2.rto_rvp_scxvertical__rvp_percentage_units,

    -- RTO_RVP_SC columns
    sub2.rto_rvp_sc__rto_percentage_value,
    sub2.rto_rvp_sc__rto_percentage_units,
    sub2.rto_rvp_sc__rvp_percentage_value,
    sub2.rto_rvp_sc__rvp_percentage_units,

    -- Tax_SC X Vertical column
    sub2.tax_scxvertical__gst_percentage,

    -- Tax_FSN column
    sub2.tax_fsn__gst_percentage,

    -- Rto_rvp_logic columns
    sub2.overall_rto_gmv_percentage,
    sub2.overall_rto_units_percentage,
    sub2.overall_rvp_gmv_percentage,
    sub2.overall_rvp_units_percentage,

    -- Tax_logic column
    sub2.overall_tax_percentage,

    -- Cogs and Im logic column
    sub2.overall_cogs_im_percentage,

    -- Bl_SC columns
    sub2.freight,
    sub2.sc_losses_excl_expiry,
    sub2.bank_burn,
    sub2.others_royalty_etc,
    sub2.expiry,
    sub2.other_inventory_provisions,
    sub2.cs,
    sub2.pg_charges,
    sub2.catalog,
    sub2.perf_marketing,
    ...
    -- SCM columns
    sub2.scmxscxvertical__final_cpu,
    sub2.scmxscxfsn__final_cpu,
    sub2.scmxsc__final_cpu,

    -- SCM logic column
    sub2.overall_final_cpu,

    -- Ads columns
    sub2.adsxfsn__absolute_or_percentage,
    sub2.adsxfsn__value,
    sub2.adsxfsn__fsn,
    sub2.adsxtoyssxbrand__total_ads_amount,
    sub2.adsxtoyssxdayxper__day_wise_ads_percentage,
    sub2.adsxfsn1__absolute_or_percentage,
    sub2.adsxfsn1__value,
    sub2.adsxfsn1__fsn,
...
FROM
    (
        SELECT
            sales1.marketplace_id,
            sales1.analytic_business_unit,
            sales1.order_date_key,
            sales1.analytic_super_category,
            sales1.analytic_category,
            sales1.analytic_sub_category,
            sales1.product_id,
            sales1.analytic_vertical,
            sales1.brand,
            sales1.Alpha_Flag,
            sales1.FBF_Flag,
            sales1.listing_price,
            sales1.gmv,
            sales1.units,
            sales1.GTA_Fee,
            sales1.PF_Fee,
            sales1.COD_Fee,
            sales1.mrp,
            sales1.listing_price_coins,
            sales1.listing_price_coins_base_currency,
            sales1.construct_fee_value,
            --CN x FSN
        ...
        FROM
            (
                SELECT
                    ...
                    CAST(DATE_FORMAT(approved_date_time, 'yyyyMMdd') AS INT) as order_date_key,
                    ...
                    sum(COALESCE(CAST(regexp_extract(construct_fee_adjustments, '"amount":([0-9.]+)[^}]*?"referenceId":"iks:001"', 1) AS double), 0)) as GTA_Fee,
                    sum(COALESCE(CAST(regexp_extract(construct_fee_adjustments, '"amount":([0-9.]+)[^}]*?"referenceId":"pf:001"', 1) AS double), 0)) as PF_Fee,
                    sum(COALESCE(CAST(regexp_extract(construct_fee_adjustments, '"amount":([0-9.]+)[^}]*?"referenceId":"cod:001"', 1) AS double), 0)) as COD_Fee,
                    sum(mrp) as mrp,
                ...
                WHERE
                    ...
                    AND CAST(DATE_FORMAT(approved_date_time, 'yyyyMMdd') AS INT) BETWEEN 20250801 AND 20250831
                    AND order_date_key between 20250101 and 20251027
                    AND sales.is_alpha_seller = TRUE
                    AND sales.is_shopsy_order = FALSE
                GROUP BY
                    prod_dim.analytic_business_unit,
                    CAST(DATE_FORMAT(approved_date_time, 'yyyyMMdd') AS INT),
                    sales.product_id,
        ...
        LEFT JOIN fdp_uploads.ds_fkint_analytics_cdo_pnl_inputs_fsn_x_month_level_cogs_2_0 as cogsxfsn
            ...
            AND cast(cogsxfsn.yearmo as string) = substring(cast(sales1.order_date_key as string), 1, 6)
        --IMXFSN
        LEFT JOIN fdp_uploads.ds_fkint_analytics_cdo_pnl_inputs_fsn_x_brand_month_level_im_2_0 as imxfsn
            ON cast(imxfsn.yearmo as string) = substring(cast(sales1.order_date_key as string), 1, 6)
        ...
        LEFT JOIN fdp_uploads.ds_fkint_analytics_cdo_pnl_inputs_sc_x_month_level_im_1_0 as imxsc
            ON cast(imxsc.yearmo as string) = substring(cast(sales1.order_date_key as string), 1, 6)
        ...
        LEFT JOIN fdp_uploads.ds_fkint_analytics_cdo_pnl_inputs_fsn_x_month_level_rto_rvp_2_0 as rto_rvp_fsn
            ...
            AND cast(rto_rvp_fsn.yearmo as string) = substring(cast(sales1.order_date_key as string), 1, 6)
        ...
        LEFT JOIN fdp_uploads.ds_fkint_analytics_cdo_pnl_inputs_sc_x_verticalbrand_x_month_level_rto_rvp_1_0 as rto_rvp_scxverticalbrand
            ON cast(rto_rvp_scxverticalbrand.yearmo as string) = substring(cast(sales1.order_date_key as string), 1, 6)
        ...
        LEFT JOIN fdp_uploads.ds_fkint_analytics_cdo_pnl_inputs_sc_x_vertical_x_month_level_rto_rvp_1_0 as rto_rvp_scxvertical
            ON cast(rto_rvp_scxvertical.yearmo as string) = substring(cast(sales1.order_date_key as string), 1, 6)
        ...
        LEFT JOIN fdp_uploads.ds_fkint_analytics_cdo_pnl_inputs_sc_x_month_level_rto_rvp_1_0 as rto_rvp_sc
            ON cast(rto_rvp_sc.yearmo as string) = substring(cast(sales1.order_date_key as string), 1, 6)
        ...
        LEFT JOIN fdp_uploads.ds_fkint_analytics_cdo_pnl_inputs_sc_x_month_level_tax_1_0 as tax_scxvertical
            ON cast(tax_scxvertical.yearmo as string) = substring(cast(sales1.order_date_key as string), 1, 6)
        ...
        LEFT JOIN fdp_uploads.ds_fkint_analytics_cdo_pnl_inputs_fsn_x_month_level_tax_1_0 as tax_fsn
            ON cast(tax_fsn.yearmo as string) = substring(cast(sales1.order_date_key as string), 1, 6)
        ...
        LEFT JOIN fdp_uploads.ds_fkint_analytics_cdo_pnl_inputs_sc_x_month_level_bl_1_0 as blxsc
            ON cast(blxsc.yearmo as string) = substring(cast(sales1.order_date_key as string), 1, 6)
        ...
        LEFT JOIN fdp_uploads.ds_fkint_analytics_cdo_pnl_inputs_sc_x_vertical_level_month_scm_2_0 as scmxscxvertical
            ON cast(scmxscxvertical.yearmo as string) = substring(cast(sales1.order_date_key as string), 1, 6)
        ...
        LEFT JOIN fdp_uploads.ds_fkint_analytics_cdo_pnl_inputs_sc_x_fsn_level_month_scm_1_0 as scmxscxfsn
            ON cast(scmxscxfsn.yearmo as string) = substring(cast(sales1.order_date_key as string), 1, 6)
        ...
        LEFT JOIN fdp_uploads.ds_fkint_analytics_cdo_pnl_inputs_sc_level_month_scm_1_0 as scmxsc
            ON cast(scmxsc.yearmo as string) = substring(cast(sales1.order_date_key as string), 1, 6)
        ...
        --total_ads_amount
            ON cast(adsxtoyssxbrand.yearmo as string) = substring(cast(sales1.order_date_key as string), 1, 6)
