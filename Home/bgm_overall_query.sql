...
(
    ...
    ON CAST(seller.seller_id AS STRING) = CAST(sales.seller_id AS STRING)
    AND seller.analytic_super_category = sales.analytic_super_category
    AND seller.analytic_vertical = sales.analytic_vertical
    AND seller.brand = sales.brand
...
(
    ...
    ON seller1.seller_id = sales.seller_id
    AND seller1.analytic_super_category = sales.analytic_super_category
...
LEFT JOIN
    ...
    WHERE LOWER(analytic_super_category) = 'babycare') as seller2
    on seller2.seller_id=sales.seller_id
    and seller2.analytic_super_category = sales.analytic_super_category
    and seller2.brand = sales.brand

--priority vertical flag
LEFT JOIN fdp_uploads.ds_fkint_analytics_cdo_bgm_priority_vertical_list_1_0 as pv
on sales.analytic_vertical=pv.vertical
