...
inventory_agg AS (
    ...
    INNER JOIN fdp_uploads.ds_fkint_analytics_cdo_manufacturing_track_1_0 AS filter_listt
...
sales_agg AS (
    ...
    FROM (
        ...
        INNER JOIN fdp_uploads.ds_fkint_analytics_cdo_manufacturing_track_1_0 AS filter_list
