...
FROM
    ...
    FROM
        ...
        FROM 
            ...
            WHERE date_dim_key  >= 20240101 and date_dim_key <= 20240810
            and date_dim_key not in (20240229)
            GROUP BY 
                month_begin_date
            ) dates
        LEFT JOIN
            ...
            AND order_date_key BETWEEN 20240101 and 20240810
            AND order_date_key not in (20240229)
            GROUP BY
                account_id,
