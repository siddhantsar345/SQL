...
# -------------------------------------------------------------------
# Dynamic filename (auto-rolls daily: sales_with_brand_YYYYMMDD.csv)
# -------------------------------------------------------------------
today_str  = datetime.datetime.now().strftime('%Y%m%d')
file_name  = f'sales_with_brand_{today_str}.csv'
...
msg['Subject'] = f'Sales with brand Daily Export — {today_str}'


body = (
   f'Automated daily Sales with brand export.\n\n'
   f'Rows: {len(df)}\n'
   f'File: {attach_name}\n'
