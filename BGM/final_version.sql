...
transacting_selection AS (
    SELECT
        ...
        prod_dim.analytic_super_category,
        prod_dim.analytic_vertical,
        0, 0, 0, 0, 0, 0, 0, 0, CAST(NULL AS STRING), 0, 0,
...
new_selection_ppv AS (
    SELECT
        ...
        analytic_super_category,
        analytic_vertical,
        0, 0, 0, 0, 0, 0, 0, 0, CAST(NULL AS STRING), 0, 0, 0, 0, 0, 0.0,
...
discovery_metrics AS (
    SELECT 
        ...
        analytic_super_category,
        analytic_vertical,
        0, 0, 0, 0, 0, 0, 0, 0, CAST(NULL AS STRING), 0, 0, 0, 0, 0, 0.0, 0, 0,
        ppv_1_lid_count, ppv_1000_lid_count, total_units, ppv_1_pid_count, ppv_1000_pid_count, ppv_1_fbf_lid_count, ppv_1000_fbf_lid_count, ppv_1_fbf_pid_count, ppv_1000_fbf_pid_count, ppv_50_lid_count, ppv_50_pid_count, ppv_50_fbf_lid_count, ppv_50_fbf_pid_count
    FROM (
        SELECT substr(cast(sales.date_key as string), 1, 6) as year_mo, sales.analytic_business_unit, sales.analytic_super_category, sales.analytic_vertical,
            ...
            sum(gross_units) as total_units,
