...
selection_overall AS (
    SELECT 
        ...
        CAST(NULL AS STRING) as lid_created_month,
        0 as listings, 0 as new_products, 
        0 as trans_lid_count, 0 as trans_pid_count, 0 as units, 0.0 as gmv,
        0 as ppv_count, 0 as ppv_count1,
        0 as ppv_1_lid_count, 0 as ppv_1000_lid_count, 0 as total_units, 0 as ppv_1_pid_count, 0 as ppv_1000_pid_count, 
        0 as ppv_1_fbf_lid_count, 0 as ppv_1000_fbf_lid_count, 0 as ppv_1_fbf_pid_count, 0 as ppv_1000_fbf_pid_count, 
        0 as ppv_50_lid_count, 0 as ppv_50_pid_count, 0 as ppv_50_fbf_lid_count, 0 as ppv_50_fbf_pid_count
    FROM bigfoot_external_neo.sp_analytics__listing_history_90d_fact as list_dim
    INNER JOIN month_end_ref med ON list_dim.process_date_key = med.report_date
    LEFT JOIN bigfoot_external_neo.sp_product__product_attribute_hive_dim prod_dim on list_dim.product_id = prod_dim.product_id
...
selection_new AS (
    SELECT 
        ...
        0 as metric_1,0 as metric_2,0 as metric_3,0 as metric_4,0 as metric_5,0 as metric_6,0 as metric_7,0 as metric_8,
        CAST(NULL AS STRING) as lid_created_month,
        count(distinct listing_id) as listings,
        count(distinct case when listing_created_on = first_seen then product_id end) as new_products,
        0 as metric_9,0 as metric_10,0 as metric_11,0.0 as metric_12,0 as metric_13,0 as metric_14,0 as metric_15,0 as metric_16,0 as metric_17,0 as metric_18,0 as metric_19,0 as metric_20,0 as metric_21,0 as metric_22,0 as metric_23,0 as metric_24,0 as metric_25,0 as metric_26,0 as metric_27
    FROM (
        select analytic_business_unit, analytic_super_category, listing_id, product_id, listing_created_on,
...
transacting_selection AS (
    SELECT
        ...
        prod_dim.analytic_super_category,
        prod_dim.analytic_vertical,
        0 as metric_1,0 as metric_2,0 as metric_3,0 as metric_4,0 as metric_5,0 as metric_6,0 as metric_7,0 as metric_8, CAST(NULL AS STRING),0 as metric_9,0 as metric_10,
        ...
        0 as metric_11,0 as metric_12,0 as metric_13,0 as metric_14,0 as metric_15,0 as metric_16,0 as metric_17,0 as metric_18,0 as metric_19,0 as metric_20,0 as metric_21,0 as metric_22,0 as metric_23,0 as metric_24,0 as metric_25
    FROM bigfoot_external_neo.cp_bi_prod_sales__forward_unit_history_fact as sales
    LEFT JOIN bigfoot_external_neo.sp_product__product_attribute_hive_dim as prod_dim on sales.product_id = prod_dim.product_id
    WHERE sales.order_date_key >= 20240801
...
new_trxn_selection AS (
    SELECT
        ...
        prod_dim.analytic_vertical,
        0 as metric_1,0 as metric_2,0 as metric_3,0 as metric_4,0 as metric_5,0 as metric_6,0 as metric_7,0 as metric_8,
        0 as metric_9,0 as metric_10,
        CASE WHEN list_dim_fact.lid_created_month < '202406' THEN 'older_202406' ELSE list_dim_fact.lid_created_month END AS lid_created_month,
        count(distinct sales.listing_id) as trans_lid_count,
        count(distinct sales.product_id) as trans_pid_count,
        sum(sales.units) as units,
        sum(sales.gmv) as gmv,
        0 as metric_11,0 as metric_12,0 as metric_13,0 as metric_14,0 as metric_15,0 as metric_16,0 as metric_17,0 as metric_18,0 as metric_19,0 as metric_20,0 as metric_21,0 as metric_22,0 as metric_23,0 as metric_24,0 as metric_25
    FROM bigfoot_external_neo.cp_bi_prod_sales__forward_unit_history_fact as sales
    LEFT JOIN bigfoot_external_neo.sp_product__product_attribute_hive_dim prod_dim on sales.product_id = prod_dim.product_id
    LEFT JOIN (select listing_id, FORMAT_DATETIME('%Y%m', listing_created_on) as lid_created_month from bigfoot_external_neo.sp_product__listing_hive_dim where marketplace_id = 'FLIPKART') list_dim_fact on list_dim_fact.listing_id = sales.listing_id
    WHERE sales.order_date_key >= 20240801 AND prod_dim.analytic_business_unit IN ("Home","Furniture")
...
new_selection_ppv AS (
    SELECT
        ...
        analytic_super_category,
        analytic_vertical,
        0 as metric_1,0 as metric_2,0 as metric_3,0 as metric_4,0 as metric_5,0 as metric_6,0 as metric_7,0 as metric_8, CAST(NULL AS STRING), 0 as metric_9, 0 as metric_10, 0 as metric_11, 0 as metric_12, 0 as metric_13, 0.0 as metric_14,
        COUNT(DISTINCT CASE WHEN total_ppvs >= 50 THEN listing_id END) AS ppv_count,
        COUNT(listing_id) AS ppv_count1,
        0 as metric_15,0 as metric_16,0 as metric_17,0 as metric_18,0 as metric_19,0 as metric_20,0 as metric_21,0 as metric_22,0 as metric_23,0 as metric_24,0 as metric_25,0 as metric_26,0 as metric_27
    FROM (
        SELECT sales.listing_id, prod_dim.analytic_business_unit, prod_dim.analytic_super_category, prod_dim.analytic_vertical,
            substring(cast(sales.date_key as string), 1, 6) as yr_month, SUM(COALESCE(sales.primary_ppvs, 0)) AS total_ppvs
        FROM bigfoot_external_neo.cp_santa__listing_performance_at_day_level_with_sales_90d_fact sales
        LEFT JOIN bigfoot_external_neo.sp_product__product_attribute_hive_dim prod_dim ON sales.product_id = prod_dim.product_id
        LEFT JOIN (SELECT listing_id, CAST(MIN(listing_created_on) AS DATE) as listing_birth_date FROM bigfoot_external_neo.sp_product__listing_hive_dim WHERE marketplace_id = 'FLIPKART' AND listing_created_on >= '2024-07-01' GROUP BY 1) lhd ON sales.listing_id = lhd.listing_id
        WHERE sales.marketplace_id = 'FLIPKART' AND sales.date_key BETWEEN 20250101 AND 20251207 AND DATE_DIFF(PARSE_DATE('%Y%m%d', CAST(sales.date_key AS STRING)), lhd.listing_birth_date, DAY) <= 90 AND lower(sales.analytic_business_unit) in ('home', 'furniture')
        GROUP BY 1, 2, 3, 4, 5
    ) as a
    GROUP BY 1, 2, 3, 4, 5
),
...
discovery_metrics AS (
    SELECT 
        ...
        analytic_super_category,
        analytic_vertical,
        0 as metric_1,0 as metric_2,0 as metric_3,0 as metric_4,0 as metric_5,0 as metric_6,0 as metric_7,0 as metric_8, CAST(NULL AS STRING), 0 as metric_9, 0 as metric_10, 0 as metric_11, 0 as metric_12, 0 as metric_13, 0.0 as metric_14, 0 as metric_15, 0 as metric_16,
    ...
    FROM (
        ...
        WHERE sales.marketplace_id = 'FLIPKART' AND sales.date_key between 20250101 and 20251130 AND lower(sales.analytic_business_unit) in ('home', 'furniture')
