-- Query would give you the data for both with and without coupon
...
ELSE "Parity" END as fsn_coupon_landscape
...
and
(CAST(date_key as INT64) between 20250101 and 20250727)
