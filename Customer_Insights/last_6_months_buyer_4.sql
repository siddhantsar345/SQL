...
fdp_uploads.ds_fkint_cp_santa_hyperlocal_vertical_bu_mapping_2_0 AS hl 
  ...
  AND lower(sales.analytic_vertical) IN (
    'shakerandsipper', 'handandwristsupport', 'skippingrope', 'resistancetube', 'fitnessgrip', 'yogamat', 'abexerciser', 'bar', 'dumbbell', 'gybag', 'gymglove', 'badmintonracquets', 'kneesupport'
  )